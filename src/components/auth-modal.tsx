...
export function AuthModal({ open, onOpenChange, mode }: AuthModalProps) {
    ...
    const handleEmailAuth = async (e: React.FormEvent) => {
        e.preventDefault();
        const endpoint = mode === "signup" ? "/api/register" : "/api/auth/signin";
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        {mode === "signin"
                            ? "Sign in to track your Valorant store"
                            : "Sign up to start tracking your favorite skins"}
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="text-center text-sm text-muted-foreground">
                    {mode === "signin" ? (
                        <p>
                            ...
                            <button onClick={() => onOpenChange(false)} className="font-semibold text-primary hover:underline">
                                Sign up
                            </button>
                        </p>
                    ) : (
